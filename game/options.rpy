...
define config.mouse = { 
    'default' : [ ('gui/curseur.png', 0, 0)] ,  
    'hand' : [ ('gui/hand-pointer.png', 0, 0)],  
    'hover' : [ ('gui/oeil.png', 0, 0)]
}
...
define config.save_directory = "WhiteHat-1785228911"
